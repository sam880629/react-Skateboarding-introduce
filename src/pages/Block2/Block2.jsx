...
const Block2 = () => {
  ...
  return (
    <>
      <div
        ref={contentRef}
        className="w-screen h-full flex  flex-col justify-center items-center relative mt-20"
      >
        <div className="flex h-[35vw]  justify-center items-center ">
          {/* 線條 */}
          <div
            ref={borderRef}
          ...
          {/* 文字內容 */}
          <div className="w-8/12 z-10 inset-0 flex flex-col justify-start items-start text-gray-200 px-24">
            <h1
              ref={titleRef}
              className="text-lg lg:text-3xl mb-2 md:mb-6 w-7/12 text-left font-bold"
            >
      ...
      {/* 圖片與塗鴉效果 */}
      <div ref={imgRef} className=" w-full  h-screen  flex mx-auto">
